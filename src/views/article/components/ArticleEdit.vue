...
const onSelectFile = (uploadFile) => {
  imageUrl.value = URL.createObjectURL(uploadFile.raw) //本地预览图片
  formModel.value.cover_img = uploadFile.raw //cover_img(后端要求)file类型
}

// 发布
const emit = defineEmits(['success']) //子传父
...
<template>
  ...
  >
    ...
    <el-form :model="formModel" ref="formRef" label-width="100px">
      <el-form-item label="文章标题" prop="title" style="width: 70%">
